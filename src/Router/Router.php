    ...
    public function route(string $url): string {
        ...
        switch ($resource) {
            ...
            case "logout":
                ...
                session_destroy();
                header("Location: /lumielan/");
                return "";

            case "basket_clear":
                (new BasketController())->clear();
                $prevUrl = $_SERVER['HTTP_REFERER'] ?? "/lumielan/";
            ...
            case "category": // ✅ Добавлен обработчик для категории
                $category = $pieces[3] ?? null;
                $productController = new ProductController();
                return $productController->getByCategory($category);
