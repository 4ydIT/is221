...
class AboutTemplate extends BaseTemplate {
    public static function getTemplate(): string {
        ...
        <main class="container mt-5">
            <h1>О нас</h1>
            <p>Студенты группы ИС-221 Кемеровского кооперативного техникума создали интернет-магазин женской одежды Lumielan.</p>
            ...
            <script>
                ...
                function init() {
                    ...
                    var placemark = new ymaps.Placemark([55.333985, 86.133801], {
                        balloonContent: "Lumielan<br>г. Кемерово, ул. Тухачевского, д. 32",
                        hintContent: "Lumielan"
                    });
