                ...
                <nav class="navbar navbar-expand-lg bg-white shadow-sm">
                    <div class="container-fluid">
                        ...
                        <a class="navbar-brand d-flex align-items-center" href="{$siteUrl}">
                            <img src="{$siteUrl}/assets/images/logo.png" width="120" height="30" class="me-2">
                        </a>
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                            <ul class="navbar-nav mb-2 mb-lg-0">
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Категории</a>
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><a class="dropdown-item" href="{$siteUrl}/category/dresses">Платья</a></li>
                                        <li><a class="dropdown-item" href="{$siteUrl}/category/tops">Верхняя одежда</a></li>
                                        <li><a class="dropdown-item" href="{$siteUrl}/category/accessories">Аксессуары</a></li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="container-fluid bg-light py-2">
                    <div class="container d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            ...
                            <span class="text-muted">+7 (995) 259-12-35</span>
                        </div>
LINE;
        ...
        $template .= <<<LINE
            ...
            <footer class="bg-light py-4 mt-auto">
                <div class="container text-center text-muted">
                    <p class="mb-0">&copy; 2025 Lumielan. Все права защищены.</p>
                </div>
            </footer>
        </body>
        </html>
