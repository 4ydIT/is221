    ...
    public static function getOrderTemplate(?array $products, float $all_sum): string {
        ...
        foreach ($products as $product) {
            ...
            <div class="row mb-2">
                ...
                <div class="col-2">{$product['size']}</div> <!-- ✅ Отображаем размер -->
        ...
        $content .= <<<FORM
            ...
            <div class="mt-4">
                ...
                <a href="/lumielan/basket_clear" class="btn btn-outline-danger me-2">Очистить корзину</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card shadow-sm mt-4">
            <div class="card-body">
                ...
                <form action="/lumielan/order" method="POST">
                    <div class="mb-3">
